...
const About = () => {
  return (
    <div  className='HomePage' style={{height:'auto'}} id='about'>
        ...
        >
          <Layout style={{fontFamily:'monospace',borderRadius:'10px',fontSize:'20px',padding:'15px',boxShadow:'rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset'}}>
            <h3 className='text-center fw-bold responsive-text' style={{fontSize:'30px',fontFamily:'cursive,monspace'}}>About Us</h3>
            <div >
