...
const Home = () => {
  ...
  <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div className="col-12 col-sm-8 col-lg-6">
        <img src="https://www.modulesgarden.com/client-area/templates/market_place/assets/img/services/development.png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
      </div>
      <div className="col-lg-6">
        <h1 className="display-5 fw-bold  lh-1 mb-3 text-white" style={{fontFamily:'sans-serif'}}> I'm <spna style={{color:'#79c2d0'}}>Srikanth</spna>, a web developer who loves making cool websites. 🚀</h1>
        <p className="lead text-white" style={{fontFamily:'monospace'}}>I started because I wanted to bring my ideas to life online. Let's make the web awesome together!</p>
